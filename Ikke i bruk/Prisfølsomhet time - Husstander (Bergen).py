...
def finne_husstander():
    for index, rad in data_answer.iterrows():
        if (
                ...
                rad[
                    "Q23"] == 9 and  # 1= Under 30 kvm, 2 = 30-49 kvm, 3 = 50-59 kvm, 4 = 60-79 kvm, 5 = 80-99 kvm, 6 = 100-119 kvm, 7 = 120-159 kvm, 8 = 160-199 kvm, 9 = 200 kvm eller større, 10 = vet ikke
                rad["Q21"] == 6
        # 1 = Under 300 000 kr, 2 = 300 000 - 499 999, 3 = 500 000 -799 999, 4 = 800 000 - 999 999, 5 = 1 000 000 - 1 499 999, 6 = 1 500 000 eller mer, 7 = Vil ikke oppgi, 8 = Vet ikke
...
def direkte_prisfolsomhet_time(test_liste_husstander, data_demand, data_price_update, data_households,
                               Bergen_Temp_t4t):
...
def lin_log_prisfolsomhet_pris_t4t(test_liste_husstander, data_demand, data_price_update, data_households,
                                   Bergen_Temp_t4t):
...
def log_lin_prisfolsomhet_pris_t4t(test_liste_husstander, data_demand, data_price_update, data_households,
                                   Bergen_Temp_t4t):
    start_dato = '2021-04-01'
    end_dato = '2022-03-31'
    start_dato = pd.to_datetime(start_dato)
...
def log_log_prisfolsomhet_t4t(test_liste_husstander, data_demand, data_price_update, data_households,
                              Bergen_Temp_t4t):
    start_dato = '2021-08-01'
    end_dato = '2021-12-31'
    start_dato = pd.to_datetime(start_dato)
...
# resultater = lin_log_prisfolsomhet_pris_t4t(liste_husstander, data_demand, data_price_update, data_households, Blindern_Temp_t4t)
# resultater = log_lin_prisfolsomhet_pris_t4t(liste_husstander,data_demand,data_price_update,data_households, Blindern_Temp_t4t)
