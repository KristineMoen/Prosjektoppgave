...
'''Regresjon for log-lin/ lin-log: 
      ...
      1) demand = beta_0 + beta_1 *log(pris) + beta_2 *T + beta_3 *T^2 + Beta_4 *T^3 + Temperatur3 + Month + Month*Temperatur3
      
      2) log(demand) = beta_0 + beta_1 *pris + beta_2 *T + beta_3 *T^2 + Beta_4 *T^3 + Temperatur3 + Month + Month*Temperatur3
'''
